...
def data_gen_target(img_test_final,target_list):
    ...
    img_tnindex = np.random.choice(len(img_test_nontarget_tot),10000,replace=False)
...
img_location = '/home/xiaoyu/home/tiny-imagenet-200/train'
...
for ifolder in sub_folder:
    img_file = glob.glob(os.path.join(ifolder,'images/*'))
