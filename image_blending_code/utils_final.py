...
def universal_perturbation_data_dependant(data_list, test_list, model, blend_img_path, encoder,sub_model_type, xi=10, delta=0.2, max_iter_uni = 10, p=np.inf, num_classes=10, overshoot=0.02, max_iter_df=10,init_batch_size = 1,t_p = 0.2):
    ...
    print('save models in %s' % config.save_model)
    for_train = True
    if not for_train:
        ...
        if sub_model_type == 'res18':
            model_dict = './saved_models/v3/n02950826/model_res50_res18_19_0.7799352750809062_613.0782641172409_img_train_1.pth'
        elif sub_model_type == 'densenet':
            model_dict = './saved_models/v3/n03977966/model_res50_densenet_19_0.8754512635379061_342.5548827648163_img_train_13.pth'
        elif sub_model_type == 'mobilenet':
            model_dict = './saved_models/v3/n01882714/model_res50_mobilenet_19_0.7082191780821918_1226.2721848487854_img_train_3.pth'
    ...
    test_data = 'test_final_'+str(config.cls_num)+'_'+config.tar_model+'_'+config.sub_model+'_'+config.job_name+'.txt'
