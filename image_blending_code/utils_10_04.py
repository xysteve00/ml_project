...
def universal_perturbation_data_dependant(data_list, test_list, model, blend_img_path, encoder,sub_model_type, xi=10, delta=0.2, max_iter_uni = 10, p=np.inf, num_classes=10, overshoot=0.02, max_iter_df=10,init_batch_size = 1,t_p = 0.2):
    ...
    if not for_train:
        ...
        if sub_model_type == 'res18':
            model_dict = './saved_models/v3/n02950826/model_res50_res18_19_0.8648867313915858_400.8907594680786_img_train_5.pth'
            ...
            model_dict = './saved_models/v3/n04347754/model_res50_mobilenet_19_0.8161764705882353_223.44175100326538_img_train_10.pth'
