...
Usage:
  find_uap.py <model> <im_path> <im_path_ntar> <im_list> <ntar_list> <blend_img_path> <sub_model> [options]
  find_uap.py (-h | --help)
  find_uap.py --version
...
if __name__ == '__main__':
    ...
    if(eval(args['--data_dep'])):
        batch_size = 1
        uap = utils.universal_perturbation_data_dependant(img_names, ntar_img_names, net, blend_img_path, encoder,sub_model_type, xi=xi, delta=delta, max_iter_uni =max_iter_uni,
