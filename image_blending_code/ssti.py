...
def train_model(model, criterion, optimizer, scheduler, num_epochs=args.epochs):
    ...
    torch.save(model.state_dict(), 'saved_models/hl_from_sm/model_{}_{}_{}_{}_{}_{}.pth'.format(args.tar_model, args.sub_model, epoch,best_acc,running_loss,os.path.basename(trainset).split('.')[0]))
    return model
